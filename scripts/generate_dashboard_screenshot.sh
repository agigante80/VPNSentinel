...
if command -v chromium-browser > /dev/null 2>&1; then
    SCREENSHOT_CMD="chromium-browser --headless --disable-gpu --screenshot='${SCREENSHOT_PATH}' --window-size=1600,800 --hide-scrollbars --virtual-time-budget=5000 '${DASHBOARD_URL}'"
elif command -v chromium > /dev/null 2>&1; then
    SCREENSHOT_CMD="chromium --headless --disable-gpu --screenshot='${SCREENSHOT_PATH}' --window-size=1600,800 --hide-scrollbars --virtual-time-budget=5000 '${DASHBOARD_URL}'"
elif command -v google-chrome > /dev/null 2>&1; then
    SCREENSHOT_CMD="google-chrome --headless --disable-gpu --screenshot='${SCREENSHOT_PATH}' --window-size=1600,800 --hide-scrollbars --virtual-time-budget=5000 '${DASHBOARD_URL}'"
elif command -v firefox > /dev/null 2>&1; then
    SCREENSHOT_CMD="firefox --headless --screenshot '${SCREENSHOT_PATH}' --window-size=1600,800 '${DASHBOARD_URL}'"
else
