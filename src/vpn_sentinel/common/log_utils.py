...
def _initialize_log_file():
    ...
    try:
        ...
        handler = RotatingFileHandler(
            log_file_path, maxBytes=MAX_LOG_SIZE_BYTES, backupCount=MAX_LOG_BACKUPS, encoding="utf-8"
        )
    ...
    if _log_file_handle:
        try:
            ...
            record = std_logging.LogRecord(
                name="vpn_sentinel", level=std_logging.INFO, pathname="", lineno=0, msg=log_line, args=(), exc_info=None
            )
