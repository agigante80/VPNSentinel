"""Deprecated server_info shim delegating to vpn_sentinel_common.server_info."""
import warnings

warnings.warn("vpn_sentinel_server.server_info is deprecated; import from vpn_sentinel_common.server_info instead", DeprecationWarning)

from vpn_sentinel_common.server_info import get_server_public_ip, get_server_info  # noqa: E402

__all__ = ["get_server_public_ip", "get_server_info"]
