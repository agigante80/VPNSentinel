"""Deprecated utils shim re-exporting helpers from vpn_sentinel_common."""
import warnings

warnings.warn("vpn_sentinel_server.utils is deprecated; import from vpn_sentinel_common.utils or logging instead", DeprecationWarning)
