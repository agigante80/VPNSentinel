...
def test_multiple_clients_register_and_listed():
    ...
    try:
        ...
        payload1 = {"client_id": "multi-client-1", "timestamp": time.time(), "public_ip": "203.0.113.10"}
        payload2 = {"client_id": "multi-client-2", "timestamp": time.time(), "public_ip": "203.0.113.11"}
