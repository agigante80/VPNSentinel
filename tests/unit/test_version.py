        ...
        with patch.dict("os.environ", {}, clear=True):
            ...
            with patch("subprocess.run", return_value=mock_result) as mock_run:
                ...
                mock_run.assert_called_once_with(
                    ["git", "rev-parse", "--short=7", "HEAD"], capture_output=True, text=True, timeout=2
                )
...
class TestGetVersionInfo:
    ...
    def test_get_version_info_complete(self):
        ...
        with patch.dict("os.environ", {"VERSION": "1.2.3", "COMMIT_HASH": "abc123def", "ENVIRONMENT": "staging"}):
    ...
    def test_get_version_info_production(self):
        ...
        with patch.dict("os.environ", {"VERSION": "2.0.0", "ENVIRONMENT": "production"}):
