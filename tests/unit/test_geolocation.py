...
from vpn_sentinel.common.geolocation import get_geolocation, _http_get, _parse_ipinfo, _parse_ip_api, _parse_ipwhois


class TestHttpGet:
    """Tests for _http_get helper function."""

    @patch("vpn_sentinel.common.geolocation.requests")
    ...
    @patch("vpn_sentinel.common.geolocation.requests", None)
...
class TestParseIpinfo:
    ...
    def test_parse_ipinfo_missing_fields(self):
        ...
        text = json.dumps({"ip": "1.2.3.4", "country": "US"})
...
class TestParseIpwhois:
    ...
    def test_parse_ipwhois_asn_fallback(self):
        ...
        text = json.dumps({"ip": "1.2.3.4", "country": "US", "asn": {"name": "Example ASN"}})
...
class TestGetGeolocation:
    ...
    @patch("vpn_sentinel.common.geolocation._http_get")
    def test_get_geolocation_auto_ipinfo_success(self, mock_http_get):
        ...
        mock_http_get.return_value = json.dumps(
            {"ip": "79.116.8.43", "city": "Madrid", "country": "ES", "org": "Hetzner", "timezone": "Europe/Madrid"}
        )
    ...
    def test_get_geolocation_fallback_to_ipapi(self, mock_http_get):
        ...
        def mock_responses(url, timeout):
            if "ipinfo.io" in url:
                ...
                return json.dumps({"query": "1.2.3.4", "city": "London", "country": "GB"})
            return None
    ...
    def test_get_geolocation_fallback_to_ipwhois(self, mock_http_get):
        ...
        def mock_responses(url, timeout):
            if "ipwhois.app" in url:
                return json.dumps({"ip": "5.6.7.8", "city": "Berlin", "country": "DE"})
    ...
    def test_get_geolocation_specific_service(self, mock_http_get):
        ...
        mock_http_get.return_value = json.dumps({"query": "1.2.3.4", "city": "Paris", "country": "FR"})
    ...
    def test_get_geolocation_custom_timeout(self, mock_http_get):
        ...
        mock_http_get.return_value = json.dumps({"ip": "1.2.3.4", "country": "US"})
